...
$pageTitle= 'Members';
	...
	if (isset($_SESSION['Username'])) {
		...
		<br><br>
			<div class="container ">
				...
				<a href="members.php?do=Add" class="btn btn-primary"style="background-color: #e99002;
    border-color: #F0F0">
    ...
    border-color: #F0F0">>Add New Member</div>
					<div class="panel-body">
						 <div class="row">
				 	<div class="col-md-12">
				<form class="from-horizontal" action="?do=Insert" method="POST" enctype="multipart/form-data">
					...
					<div class="row">
						...
						<div class="col-sm-offset-2 col-sm-10">
							<input type="submit" value="Add Member" class="btn btn-primary btn-sm" style="background-color: #e99002;
    border-color: #F0F0">>
						</div>
					</div>
					</div>
  ...
  <?php 
			...
			<div class="container">
				<div class="panel panel-primary">
					<div class="panel-heading text-center"style="background-color: #e99002;
    border-color: #F0F0">Edit Member</div>
					<div class="panel-body">
						 <div class="row">
				 	<div class="col-md-12">
