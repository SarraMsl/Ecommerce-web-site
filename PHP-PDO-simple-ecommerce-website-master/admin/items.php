<?php
	...
	*/
			...
			<div class="container ">
				<div class="panel panel-default">
					...
					<div class="">
						...
						<a href="items.php?do=Add" class="btn btn-sm btn-primary" style="background-color: #e99002;
    border-color: #F0F0">
    ...
    border-color: #F0F0">>Add New Product</div>
					<div class="panel-body">
						 <div class="row">
				 	<div class="col-md-12">
						<form class="from-horizontal" action="?do=Insert" method="POST" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="col-sm-offset-2 col-sm-10">
									<input type="submit" value="Add Item" class="btn btn-primary btn-sm" style="background-color: #e99002;
    border-color: #F0F0">
								</div>
							</div>
							</div>
			...
			<div class="container">
				<div class="panel panel-primary">
					<div class="panel-heading text-center" style="background-color: #e99002;
    border-color: #F0F0">>Edit Product</div>
					<div class="panel-body">
						 <div class="row">
				 	<div class="col-md-12">
						<form class="from-horizontal" action="?do=Update" method="POST">
							...
							<div class="row">
								<div class="form-group form-group-sm">
								<div class="col-sm-offset-2 col-sm-10">
									<input type="submit" value="Save Item" class="btn btn-primary btn-sm" style="background-color: #e99002;
    border-color: #F0F0">
								</div>
							</div>
							</div>
