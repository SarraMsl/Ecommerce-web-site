<?php 
	...
	if (isset($_SESSION['Username'])) {
		...
		$numUser = 4; // Number Of Lastest Users 
		...
		<div class="home-stats">
			<div class="container text-center">
				<h1><i class="fa fa-user fa-x"></i> Admin Panel</h1>  
											...
											foreach ($latestItems as $item) {
												...
												echo '<li>'; 
													...
													echo '<a href="items.php?do=Edit&itemid='. $item['Item_ID'] .'">';
														echo '<span class="btn btn-success pull-right">';
															echo '<span<i class="fa fa-edit"></i> Edit';


														 	if ($item['Approve'] == 0){

																echo '<a href="items.php?do=Approve&itemid='.$item['Item_ID'] . '">';
																echo '<span class="btn btn-info pull-right activate">';
																echo '<span<i class="fa fa-check"></i> Approve';	
														 	}														
														echo '</span>';
													echo '</a>';
												echo '</li>';			
