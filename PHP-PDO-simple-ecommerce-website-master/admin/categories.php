				...
				if(! empty($cats)) {
					...
					<div class="container categories">
						<div class="panel panel-default">
							<div class="panel panel-heading text-center" style="background-color: #e99002;
    border-color: #F0F0">
						...
						<a class="add-category btn btn-primary"  style="background-color: #e99002;
    border-color: #F0F0"  href="categories.php?do=Add"><i class="fa fa-plus" ></i> Add New Category</a>
					</div>
					...
					echo '<div class="container">';
						...
						echo'<a class="add-category style="background-color: #e99002;
						border-color: #F0F0">btn btn-primary"href="categories.php?do=Add"><i class="fa fa-plus" ></i> Add New Category</a>';				
					echo "</div>";	
				} 
			...
			<div class="container">
				<div class="panel panel-primary">
					<div class="panel-heading text-center"style="background-color: #e99002;
    border-color: #F0F0">Add New Category</div>
					<div class="panel-body">
						 <div class="row">
				 	<div class="col-md-12">
						...
						<form class="from-horizontal" action="?do=Insert" method="POST">
							...
							<div class="row">
								...
								<div class="col-sm-offset-2 col-sm-10">
									<input type="submit" value="Add Category" class="btn btn-primary btn-sm"style="background-color: #e99002;
    border-color: #F0F0">
								</div>
							</div>
							</div>
			...
			<div class="container">
				<div class="panel panel-primary">
					<div class="panel-heading text-center"style="background-color: #e99002;
    border-color: #F0F0">Edit Category</div>
					<div class="panel-body">
						 <div class="row">
				 	<div class="col-md-12">
					<form class="from-horizontal" action="?do=Update" method="POST">
						...
						<div class="row">
							<div class="form-group form-group-sm">
							<div class="col-sm-offset-2 col-sm-10">
								<input type="submit" value="Save" class="btn btn-primary btn-sm" style="background-color: #e99002;
    border-color: #F0F0">
							</div>
						</div>
						</div>
